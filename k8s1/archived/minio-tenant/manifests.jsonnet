...
local tenant_name = (import 'config.libsonnet').tenant_name;
      ...
      helm: {
        ...
        valuesObject: {
            tenant: {
              ...
              certificate: {
                // https://github.com/minio/operator/blob/e054c34ee36535b1323337816450dd7b3fcac482/helm/tenant/values.yaml#L270-L272
